	...
	<body>
		...
		<div id="page" class="page">
			...
			<header id="header" class="header">
				<nav class="navbar fixed-top navbar-expand-md navbar-light bg-tra hover-menu white-scroll">
					<div class="container">
						...
						<!-- For Retina Ready displays take a image with double the amount of pixels that your image will be displayed (e.g 240 x 60 pixels) -->
				 		<a href="#hero-12" class="navbar-brand logo-black"><img src="images/logo.svg" width="130" height="65" alt="header-logo"></a>
				 		<a href="#hero-12" class="navbar-brand logo-white"><img src="images/logo-white.png" width="130" height="65" alt="header-logo"></a>
				 		...
				 		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
				  		...
				  		<div id="navbarSupportedContent" class="collapse navbar-collapse">				  			
                      			...
                      			<li class="nav-item dropdown">
		                            ...
		                            <!-- Dropdown Menu -->
                           			<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> 
                           				<li><a class="dropdown-item" href="#content-6">About ShiftKey</a></li>                         				
		                                <li><a class="dropdown-item" href="#content-3">Best Solutions</a></li>
		                                <li><a class="dropdown-item" href="#services-6">Why ShiftKey</a></li>		                                
		                                <li><a class="dropdown-item" href="#video-3">Watch Video</a></li>
		                                <li><a class="dropdown-item" href="#reviews-2">Testimonials</a></li>		                               	
                            		</ul>
                        		</li>
                        		    
                        		<li class="nav-item nl-simple"><a class="nav-link" href="#services-4">Services</a></li>                        							     		
                      			...
                      			<li class="nav-item dropdown">
		                            ...
		                            <!-- Dropdown Menu -->
                           			<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> 
		                                ...
		                                <li><a class="dropdown-item" href="about.html">About ShiftKey</a></li>
					      	...
					      	<span class="navbar-text">						      															
								<a href="#contacts-1" class="btn btn-tra-grey primary-color-hover">Try For Free</a>
						    </span>	
			...
			<!-- HERO-12
			============================================= -->	
			<section id="hero-12" class="bg-fixed hero-section division">
				<div class="container">						
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-5">
							<div class="hero-txt mb-40">
								...
								<!-- Title -->
								<h2>Hacemos su web mas poderosa</h2>

								<!-- Text -->
								<p class="p-md">Donec vel sapien augue integer urna turpis vel cursus porta, mauris
								   sed augue luctus magna dolor luctus neque primis libero tempor
								</p> 

								<!-- Button -->
								<a href="#" class="btn btn-primary-color tra-black-hover">Buy Now For - $15</a>	
						...
						<!-- HERO IMAGE -->
						<div class="col-md-7">	
							<div class="hero-12-img text-center mb-40">
			 		...
			 		<div class="row">
	 					...
	 					<div class="col-sm-6 col-md-4">
	 						<div class="sbox-4 wow fadeInUp" data-wow-delay="0.4s">
	 							...
	 							<!-- Icon -->
								<img class="img-65" src="images/icons/monitor.png" alt="service-icon" />

								<!-- Text -->
								<div class="sbox-4-txt">
	
									<!-- Title -->
									<h5 class="h5-sm">Interfaz amigable</h5>
										
									<!-- Text -->
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus an auctor
									   tempus feugiat dolor an impedit
									</p>
	 					...
	 					<div class="col-sm-6 col-md-4">
	 						<div class="sbox-4 wow fadeInUp" data-wow-delay="0.6s">
	 							...
	 							<!-- Icon -->
								<img class="img-65" src="images/icons/settings-1.png" alt="service-icon" />

								<!-- Text -->
								<div class="sbox-4-txt">
	
									<!-- Title -->
									<h5 class="h5-sm">Opciones poderosas</h5>
	 					...
	 					<div class="col-sm-6 col-md-4">
	 						<div class="sbox-4 wow fadeInUp" data-wow-delay="0.8s">
	 							...
	 							<!-- Icon -->
								<img class="img-65" src="images/icons/structure.png" alt="service-icon" />

								<!-- Text -->
								<div class="sbox-4-txt">
	
									<!-- Title -->
									<h5 class="h5-sm">Código organizado</h5>
	 					...
	 					<div class="col-sm-6 col-md-4">
	 						<div class="sbox-4 wow fadeInUp" data-wow-delay="1s">
	 							...
	 							<!-- Icon -->
								<img class="img-65" src="images/icons/worldwide-2.png" alt="service-icon" />

								<!-- Text -->
								<div class="sbox-4-txt">
	
									<!-- Title -->
									<h5 class="h5-sm">Soporte multilingüe</h5>
	 					...
	 					<div class="col-sm-6 col-md-4">
	 						<div class="sbox-4 wow fadeInUp" data-wow-delay="1.2s">
	 							...
	 							<!-- Icon -->
								<img class="img-65" src="images/icons/padlock-1.png" alt="service-icon" />

								<!-- Text -->
								<div class="sbox-4-txt">
	
									<!-- Title -->
									<h5 class="h5-sm">Seguridad Concreta</h5>
	 					...
	 					<!-- SERVICE BOX #6 -->
	 					<div class="col-sm-6 col-md-4">
	 						<div class="sbox-4 wow fadeInUp" data-wow-delay="1.4s">

	 							<!-- Icon -->
								<img class="img-65" src="images/icons/faq.png" alt="service-icon" />

								<!-- Text -->
								<div class="sbox-4-txt">
	
									<!-- Title -->
									<h5 class="h5-sm">Soporte Premium</h5>
			...
			<!-- CONTENT-6
			============================================= -->
			<section id="content-6" class="pt-100 content-section division">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Section ID -->	
					 			<span class="section-id primary-color">BELLEZA DE LA SENCILLEZ</span>
							
					 			<!-- Title -->	
								<h3 class="h3-md">Mejore el diseño de su sitio web con ShiftKey</h3>
				...
				<div class="container white-color">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">	
							...
							<!-- Title 	-->	
							<h3 class="h3-lg">Aplicación más rápida y potente</h3>	
							...
							<div class="row">
								...
								<div class="col-sm-4">							
									<div class="statistic-block wow fadeInUp" data-wow-delay="0.4s">							
										...
										<p class="txt-400">Fast Load Time</p>							
									</div>								
								</div>
								...
								<div class="col-sm-4">									
									<div class="statistic-block wow fadeInUp" data-wow-delay="0.6s">										
										...
										<p class="txt-400">More Productivity</p>	
									</div>							
								</div>
								...
								<div class="col-sm-4">						
									<div class="statistic-block wow fadeInUp" data-wow-delay="0.8s">									
										<h5 class="statistic-number"><span class="count-element">43</span>%</h5>
										<p class="txt-400">Less RAM Loading</p>	
									</div>						
								</div>
			...
			<!-- CONTENT-3
			============================================= -->
			<section id="content-3" class="wide-60 content-section division">
			 	<div class="container">
			 		<div class="row d-flex align-items-center">
								...
								<div id="list-tab" class="list-group primary-theme" role="tablist">
								    ...
								    <a id="tab1-list" class="list-group-item list-group-item-action active" data-toggle="list" href="#tab-1" role="tab" aria-controls="tab-1">
								    	<div class="cbox-4">
								    		...
								    		<!-- Text -->
											<h5 class="h5-sm">Integración de funciones</h5>
								    ...
								    <a id="tab2-list" class="list-group-item list-group-item-action" data-toggle="list" href="#tab-2" role="tab" aria-controls="tab-2">
								    	<div class="cbox-4">	
								    		...
								    		<!-- Text -->
											<h5 class="h5-sm">Comentarios y menciones</h5>
								    ...
								    <a id="tab3-list" class="list-group-item list-group-item-action" data-toggle="list" href="#tab-3" role="tab" aria-controls="tab-3">
								    	<div class="cbox-4">
								    		...
								    		<!-- Text -->																	
											<h5 class="h5-sm">Interfaz de usuario elegante</h5>
			 				...
			 				<div class="img-block pr-30 wow fadeInUp" data-wow-delay="0.6s">
								<div id="nav-tabContent" class="tab-content">
								    ...
								    <div id="tab-1" class="tab-pane show active" role="tabpanel" aria-labelledby="tab1-list">
								    	<img class="img-fluid" src="images/tab-1-img.png" alt="tab-image" />	
								    </div>
								    ...
								    <div id="tab-2" class="tab-pane" role="tabpanel" aria-labelledby="tab2-list">
								    	<div class="video-preview text-center">
											...
											<a class="video-popup2" href="https://www.youtube.com/watch?v=7e90gBu4pas">
												...
												<!-- Preview Image -->
												<img class="img-fluid" src="images/tab-2-img.png" alt="video-preview">
								    ...
								    <div id="tab-3" class="tab-pane" role="tabpanel" aria-labelledby="tab3-list">
								    	<img class="img-fluid" src="images/tab-3-img.png" alt="tab-image" />
								    </div>
			...
			<!-- SERVICES-6
			============================================= -->
			<section id="services-6" class="bg-lightgrey wide-60 services-section division">
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">			
							...
							<!-- Title 	-->	
							<h3 class="h3-md">Qué hace que ShiftKey sea diferente</h3>	
			 		...
			 		<div class="row">
						...
						<!-- SERVICE BOX #1 -->
						<div class="col-md-4">
							<div class="sbox-6 wow fadeInUp" data-wow-delay="0.4s">
								
								<!-- Icon -->
								<img class="img-95" src="images/icons/idea-5.png" alt="service-icon" /> 

								<!-- Title -->
								<h5 class="h5-md">Diseño moderno</h5>
								...
								<!-- Link -->
								<a href="#" class="btn btn-sm btn-tra-grey blue-hover">Learn More</a>								
						...
						<!-- SERVICE BOX #2 -->
						<div class="col-md-4">
							<div class="sbox-6 wow fadeInUp" data-wow-delay="0.6s">
								
								<!-- Icon -->
								<img class="img-95" src="images/icons/file.png" alt="service-icon" /> 

								<!-- Title -->
								<h5 class="h5-md">Opciones poderosas</h5>
						...
						<!-- SERVICE BOX #3 -->
						<div class="col-md-4">
							<div class="sbox-6 wow fadeInUp" data-wow-delay="0.8s">
								
								<!-- Icon -->
								<img class="img-95" src="images/icons/key.png" alt="service-icon" /> 
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- CONTENT BOX #1 -->
								<div class="cbox-3 icon-xs mb-10">

									<!-- Icon -->
									<img class="img-65" src="images/icons/cloud-computing.png" alt="service-icon" />

									<!-- Text -->
									<div class="cbox-3-txt">

										<!-- Title -->
										<h5 class="h5-sm">Soporte de base de datos integrado</h5>

										<!-- Text -->
										<p>Velna iaculis odio auctor integer congue impedit magna at dolor vitae gravida
										   donec mauris lectus luctus ultrice tellus viverra potenti neque
										</p>
								...
								<div class="cbox-3 icon-xs mb-10">
									...
									<!-- Icon -->
									<img class="img-65" src="images/icons/network-2.png" alt="service-icon" />

									<!-- Text -->
									<div class="cbox-3-txt">

										<!-- Title -->
										<h5 class="h5-sm">Flujo de trabajo transparente</h5>
								...
								<!-- CONTENT BOX #3 -->
								<div class="cbox-3 icon-xs">

									<!-- Icon -->
									<img class="img-65" src="images/icons/worldwide.png" alt="service-icon" />
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">	
							...
							<!-- Title 	-->	
							<h3 class="h3-md">Lo que nuestros clientes están diciendo</h3>	
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">	
							...
							<!-- Title 	-->	
							<h3 class="h3-md">Preguntas frecuentes</h3>	
						...
						<div class="col-lg-6">
							<div class="questions-holder">
								...
								<div class="question wow fadeInUp" data-wow-delay="0.4s">
									...
									<!-- Question -->
									<h5 class="h5-xs">¿Tienen descuento para organizaciones sin fines de lucro?</h5>
								...
								<div class="question wow fadeInUp" data-wow-delay="0.6s">
									...
									<!-- Question -->
									<h5 class="h5-xs">¿Tiene una prueba gratuita?</h5>

									<!-- Answer -->
									<ul class="content-list mb-35">
								...
								<div class="question wow fadeInUp" data-wow-delay="0.8s">
									...
									<!-- Question -->
									<h5 class="h5-xs">How do I install a ShiftKey?</h5>
						...
						<div class="col-lg-6">
							<div class="questions-holder ind-30">
								...
								<div class="question wow fadeInUp" data-wow-delay="0.4s">
									...
									<!-- Question -->
									<h5 class="h5-xs">¿Qué puedo hacer con mi compra?</h5>
								...
								<div class="question wow fadeInUp" data-wow-delay="0.6s">
									...
									<!-- Question -->
									<h5 class="h5-xs">¿Cómo puedo actualizar o cancelar mi información personal?</h5>
								...
								<div class="question wow fadeInUp" data-wow-delay="0.8s">
									...
									<!-- Question -->
									<h5 class="h5-xs">I have technical problem, who do I email?</h5>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="more-questions wow fadeInUp" data-wow-delay="1.2s">
								<h5 class="h5-xs">Still have a question? <a href="faqs.html">Ask your question here</a></h5>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-10 offset-lg-1">
							<div class="cta-txt text-center">
								...
								<!-- Title -->
								<h3 class="h3-xs">Crea mejores experiencias con ShiftKey</h3>
								...
								<div class="btns-group">
									...
									<a href="#" class="btn btn-tra-white black-hover">Buy For Only $14.99</a>
								</div>	
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">		
							...
							<!-- Title 	-->	
							<h3 class="h3-md">Nuestras historias y últimas noticias</h3>	
			        ...
			        <!-- SECTION TITLE -->  
			         <div class="row"> 
			            <div class="col-lg-10 offset-lg-1 section-title">
			              	...
			              	<!-- Title  --> 
			             	 <h3 class="h3-md">¿Busca apoyo? Ponerse en contacto</h3>  
				            ...
				            <div class="form-holder">
				                <form name="contactform" class="row contact-form">
					                ...
					                <div class="col-lg-12 mt-15 form-btn">  
					                	<button type="submit" class="btn btn-primary-color black-hover submit">Send Your Message</button> 
					                </div>
					...
					<div class="row">
						...
						<div class="col-md-10 col-lg-4">
							<div class="footer-info mb-40">
								...
								<img src="images/footer-logo.svg" width="175" height="35" alt="footer-logo">
